          ...
          <Row>
            <Col xs="12" md="6" > 
              ...
              <div className="text-center"> 
                <Button  onClick={e => this.props.registerCatererClicked(e)} style={{fontSize: 18, height: 50, marginTop: 10, marginBottom: 30,}} className="bg-primary" size="lg" color="primary">Register As Caterer</Button>
              </div>
